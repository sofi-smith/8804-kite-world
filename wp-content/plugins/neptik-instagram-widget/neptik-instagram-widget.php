<?php
/*
Plugin Name: Neptik Instagram Widget
Plugin URI: http://www.neptik.com/
...
This comment is added for compatibility with the null framework http://www.neptik.com
...
if (is_plugin_active('neptik-instagram-widget/neptik-instagram-widget.php')) {
