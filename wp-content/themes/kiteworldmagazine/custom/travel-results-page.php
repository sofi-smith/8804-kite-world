 ...
 * Template Name: Travel Results Page - Right Bar
 * @package WordPress
   ...
   <div class="row spacer">
        <div class="main-content-container general-listing-page col-md-12">
            <section class="top-box">
                ...
                <form action="http://kite-world.co.uk/?page_id=317" method="post" onsubmit="searchResult()">
                  <div class="row">
                    <div class="col-sm-5">
                        <h3>Location</h3>
    ...
    <section class="page-content second">
            ...
            <div id="travel-results">
               ...
               elseif(!empty($_POST['continent'])):
                   $search .= $_POST['continent'];
               endif;

               if(!empty($_POST['style'])):
                   $search .= ','.implode(',',$_POST['style']);
               else:
                   $search .= '';
               endif;
               if(!empty($_POST['season'])):
                   $search .= ','.implode(',',$_POST['season']);
               else:
                   $search .= '';
               endif;
